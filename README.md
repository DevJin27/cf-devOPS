...
- Optional R2 snapshot persistence.
...
R2 is optional for the MVP. If your account has R2 enabled, add this binding back to `apps/api-worker/wrangler.jsonc`:

```jsonc
"r2_buckets": [
  {
    "binding": "SNAPSHOTS",
    "bucket_name": "cursor-devops-snapshots"
  }
]
```
